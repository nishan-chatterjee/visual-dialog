...
def add_dataset_args(parser):
    ...
    group.add_argument('--train_feat_img_path', metavar='PATH',
                       default='datasets/bottom-up-attention/trainval_resnet101_faster_rcnn_genome__num_boxes_100_100.h5')
    group.add_argument('--val_feat_img_path', metavar='PATH',
                       default='datasets/bottom-up-attention/val2018_resnet101_faster_rcnn_genome__num_boxes_100_100.h5')
    group.add_argument('--test_feat_img_path', metavar='PATH',
                       default='datasets/bottom-up-attention/test2018_resnet101_faster_rcnn_genome__num_boxes_100_100.h5')
